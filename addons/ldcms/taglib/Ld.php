...
eof;
    ...
    {
        $parse = '<?php ';
        $parse .= '$item=\addons\ldcms\model\Document::instance()->getPrevNext($content["id"],$content["cid"],"prev");';
    ...
    {
        $parse = '<?php ';
        $parse .= '$item=\addons\ldcms\model\Document::instance()->getPrevNext($content["id"],$content["cid"],"next");';
        $parse .= 'if($item): ?>' . $content . '<?php endif; unset($item); ?>';
        return $parse;
    }
