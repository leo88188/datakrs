...
INSERT INTO `__PREFIX__ldcms_category` (`id`, `name`, `ename`, `pid`, `mid`, `urlname`, `template_list`, `template_detail`, `outlink`, `image`, `big_image`, `seo_title`, `seo_keywords`, `seo_description`, `sort`, `lang`, `is_target`, `type`, `gid`, `status`, `create_time`, `update_time`, `is_nav`) VALUES
...
(14, 6, 'test', 'selectpage', '测试', NULL, '', '', '', 0, 255, 0, 0, '', '{\"table\":\"__PREFIX__ldcms_document\",\"primarykey\":\"id\",\"field\":\"title\",\"key\":\"\",\"value\":\"\",\"conditions\":\"{}\"}', 9, 1665458553, 1673140330, 0, 0, 1, ''),
(15, 7, 'test1', 'selectpage', '测试关联表', NULL, '', '', '', 0, 255, 0, 0, '', '{\"table\":\"__PREFIX__ldcms_category\",\"primarykey\":\"id\",\"field\":\"name\",\"conditions\":\"{}\"}', 9, 1665469184, 1665475043, 0, 0, 1, ''),
