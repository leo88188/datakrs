...
class Langs extends Backend
{
    ...
    public static function init()
    {
        ...
        self::afterInsert(function ($data) {
            ...
            self::createLangFile(self::$siteinfopath . $data['code'] . '.php', self::$siteinfopath . 'zh-cn.php');
        });
        ...
        self::beforeUpdate(function ($data) {
            ...
            if ($old_data['code'] != $data['code']) {
                ...
                rename(self::$siteinfopath . $old_data['code'] . '.php', self::$siteinfopath . $data['code'] . '.php');
            }
        });
        ...
        self::afterDelete(function ($data) {
            ...
            @unlink(self::$siteinfopath . $data['code'] . '.php');
            /*删除语言后重置后台语言为默认语言*/
