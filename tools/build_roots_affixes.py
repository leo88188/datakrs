...
ROOT_ORIGIN_NOTES = {
    "act/ag": "来源：拉丁语 agere（行动、驱动）。看到 act/ag 先按“做事、推动事情发生”理解。",
    "anim": "来源：拉丁语 anima（气息、生命）。从“有生命气息”延伸到精神、活力。",
    "ann/enn": "来源：拉丁语 annus（年）。常出现在年度、周年、持续多年的表达里。",
    "anthrop": "来源：希腊语 anthropos（人）。常用于人类、人群和人类行为研究。",
    "aqu": "来源：拉丁语 aqua（水）。看到 aqu 优先联想到水域、水体和水相关设施。",
    "aud": "来源：拉丁语 audire（听）。常指听觉、听众、声音接收。",
    "auto": "来源：希腊语 autos（自己）。表示自己完成、自动或独立控制。",
    "bio": "来源：希腊语 bios（生命）。常进入生物、生命过程、生命叙事相关词。",
    "cap/cept/cip": "来源：拉丁语 capere（拿取、接受）。可理解为抓住、接收、占有。",
    "ced/ceed/cess": "来源：拉丁语 cedere（走、让步）。常表达前进、进入、退让或过程推进。",
    "chron": "来源：希腊语 chronos（时间）。用于时间顺序、长期状态、同步关系。",
    "cid/cis": "来源：拉丁语 caedere/cidere（切、砍）。从“切开”延伸为决定、精确、杀伤。",
    "circ": "来源：拉丁语 circus/circulus（圆、环）。表示围绕、环状或周边条件。",
    "claim/clam": "来源：拉丁语 clamare（喊叫）。从喊出来延伸为宣称、声明、呼吁。",
    "cogn/gnos": "来源：拉丁语 cognoscere 与希腊语 gnosis（认识、知识）。常指认知、识别、诊断。",
    "corp": "来源：拉丁语 corpus（身体、实体）。从身体延伸到组织、公司、整体实体。",
    "cred": "来源：拉丁语 credere（相信）。常进入信用、可信、信念相关词。",
    "cur/curs": "来源：拉丁语 currere（跑、流动）。可理解为跑动、流向、发生路径。",
    "cycl": "来源：希腊语 kyklos（圆、环）。常指循环、周期、环形运动。",
    "dem": "来源：希腊语 demos（人民）。常出现在民主、人口、人群传播相关词。",
    "dict": "来源：拉丁语 dicere（说）。从说话延伸到命令、预言、词典记录。",
    "duc/duct": "来源：拉丁语 ducere（引导、带领）。常表示带出、导向、传导。",
    "fac/fect/fic": "来源：拉丁语 facere（做、制造）。常表示制作、形成、产生效果。",
    "fer": "来源：拉丁语 ferre（携带、带来）。常表达转移、引用、承载。",
    "fid": "来源：拉丁语 fides（信任、忠诚）。常进入信心、忠诚、可信关系。",
    "fin": "来源：拉丁语 finis（边界、结束）。从边界延伸到定义、最终、有限。",
    "flex/flect": "来源：拉丁语 flectere（弯曲、转向）。常表示弯折、反射、偏转。",
    "form": "来源：拉丁语 forma（形状）。常表示形态、形成、改变形状。",
    "fort": "来源：拉丁语 fortis（强壮）。常和力量、加强、防护有关。",
    "fract/frag": "来源：拉丁语 frangere（打碎）。常指碎裂、片段、脆弱。",
    "gen": "来源：希腊语/拉丁语 gen（产生、出生、种类）。常见于生成、基因、类别。",
    "geo": "来源：希腊语 ge（地球、土地）。常用于地理、地质、地热。",
    "grad/gress": "来源：拉丁语 gradus（步、等级）。从一步一步延伸到进步、逐渐、毕业。",
    "graph": "来源：希腊语 graphein（写、画）。常指记录、图形、书写。",
    "hab/hibit": "来源：拉丁语 habere（持有、拥有）。延伸到习惯、居住、展示。",
    "ject": "来源：拉丁语 jacere（投掷）。常表示抛出、投射、拒回。",
    "jud/jur": "来源：拉丁语 ius/iudicare（法律、判断）。用于法律、陪审、裁判。",
    "junct": "来源：拉丁语 jungere（连接）。常指连接点、结合、联合。",
    "labor": "来源：拉丁语 labor（劳动）。用于工作、协作、加工展开。",
    "lat": "来源：拉丁语 latus/ferre 相关形态（带、侧）。常表达携带、关联、侧面。",
    "leg/lect": "来源：拉丁语 legere（读、选择、收集）。也和法律 legal 的词族相连。",
    "liber": "来源：拉丁语 liber（自由）。常用于自由、解放、开明。",
    "loc": "来源：拉丁语 locus（地方）。常指位置、本地、分配到某处。",
    "log/loqu": "来源：希腊语 logos（话语、逻辑）与拉丁语 loqui（说）。常指语言、论述、逻辑。",
    "luc/lum": "来源：拉丁语 lux/lumen（光）。常表示明亮、照亮、清楚。",
    "magn": "来源：拉丁语 magnus（大）。常表达巨大、放大、重要程度。",
    "manu": "来源：拉丁语 manus（手）。常见于手工、制造、手稿。",
    "mar/mer": "来源：拉丁语 mare（海）。常用于海洋、航海、水下。",
    "mater/matr": "来源：拉丁语 mater（母亲）。从母体延伸到来源、孕育、矩阵。",
    "medi": "来源：拉丁语 medius（中间）。常指中介、中间层、调解。",
    "mem": "来源：拉丁语 memoria（记忆）。常用于记忆、纪念、回想。",
    "migr": "来源：拉丁语 migrare（迁移）。常指迁徙、移民、移动到别处。",
    "min": "来源：拉丁语 minor/minimus（小、少）。常表达减少、较小、最低。",
    "mit/miss": "来源：拉丁语 mittere（送出、放出）。常指提交、派遣、发射。",
    "mob/mot/mov": "来源：拉丁语 movere（移动）。常用于运动、移动、推动变化。",
    "morph": "来源：希腊语 morphe（形态）。常指形状、结构变化、形态学。",
    "nat": "来源：拉丁语 nasci（出生）。从出生延伸到自然、本土、天生。",
    "nav": "来源：拉丁语 navis（船）。常用于海军、航行、导航。",
    "neg": "来源：拉丁语 negare（否认）。常指否定、忽视、拒绝。",
    "nom/nym": "来源：拉丁语 nomen 与希腊语 onyma（名字）。常指命名、匿名、同义词。",
    "nov": "来源：拉丁语 novus（新）。常表示新事物、创新、翻新。",
    "numer": "来源：拉丁语 numerus（数）。常用于数量、编号、列举。",
    "omni": "来源：拉丁语 omnis（全部）。表示所有、全能、全范围。",
    "path": "来源：希腊语 pathos（感受、痛苦）。常进入情感、疾病、病理相关词。",
    "ped": "来源：拉丁语 pes/pedis（脚）及希腊语 pais（儿童）。按语境判断脚、儿童或教育。",
    "pel/puls": "来源：拉丁语 pellere/pulsare（推、驱动）。常表示推动、排斥、冲动。",
    "pend/pens": "来源：拉丁语 pendere（悬挂、称重）。延伸到依赖、暂停、支出。",
    "phon": "来源：希腊语 phone（声音）。常用于电话、语音、音系。",
    "photo": "来源：希腊语 phos/photos（光）。常用于照片、光合作用、光照过程。",
    "plac": "来源：拉丁语 placere（取悦、使平静）及 place 词族。按语境理解为平稳、位置或取悦。",
    "port": "来源：拉丁语 portare（携带）与 portus（港口）。常指携带、运输、进出口。",
    "pos/pon": "来源：拉丁语 ponere（放置）。常表示位置、放在一起、推迟放置。",
    "prim": "来源：拉丁语 primus（第一）。常指首要、主要、原始阶段。",
    "prob/prov": "来源：拉丁语 probare（测试、证明）。常表示证明、批准、可能性判断。",
    "psych": "来源：希腊语 psyche（心灵、精神）。常用于心理、精神、心理医学。",
    "punct": "来源：拉丁语 pungere（刺、点）。常指点、刺孔、标点和准点。",
    "quer/quis/quest": "来源：拉丁语 quaerere（寻找、询问）。常用于问题、请求、调查。",
    "rupt": "来源：拉丁语 rumpere（打破）。常表达破裂、中断、爆发。",
    "sci": "来源：拉丁语 scire（知道）。常进入知识、科学、意识。",
    "scrib/script": "来源：拉丁语 scribere（写）。常表示书写、脚本、描述。",
    "sect/sec": "来源：拉丁语 secare（切）。常指切分、部分、剖析。",
    "sens/sent": "来源：拉丁语 sentire（感觉、认为）。常表示感知、观点、同意。",
    "sequ/sec": "来源：拉丁语 sequi（跟随）。常指顺序、随后、结果。",
    "serv": "来源：拉丁语 servare（保存）与 servire（服务）。按语境理解为保存或服务。",
    "sign": "来源：拉丁语 signum（标记、信号）。常指符号、信号、意义。",
    "simil/simul": "来源：拉丁语 similis（相似）。常表达类似、模拟、同时出现。",
    "sol": "来源：拉丁语 sol（太阳）与 solus（单独）。按语境判断太阳或独自。",
    "spec/spic": "来源：拉丁语 specere（看）。常表示观察、检查、视角。",
    "spir": "来源：拉丁语 spirare（呼吸）。从呼吸延伸到精神、激励、呼吸作用。",
    "sta/stat/stit": "来源：拉丁语 stare（站立）。常指状态、稳定、机构建立。",
    "struct": "来源：拉丁语 struere（建造、堆叠）。常表示结构、建设、基础设施。",
    "tang/tact": "来源：拉丁语 tangere（触摸）。常指接触、可触摸、完整未碰坏。",
    "temp": "来源：拉丁语 tempus（时间）。常用于临时、同时代、节奏。",
    "ten/tain": "来源：拉丁语 tenere（握住、保持）。常表示包含、保留、维持。",
    "tend/tens/tent": "来源：拉丁语 tendere（伸展、趋向）。常指延伸、紧张、倾向。",
    "terr": "来源：拉丁语 terra（土地）与 terrere（使害怕）。按语境判断土地或恐惧。",
    "therm": "来源：希腊语 therme（热）。常用于热量、温度、地热。",
    "tract": "来源：拉丁语 trahere（拉）。常表示吸引、抽取、合同中的牵引关系。",
    "urb": "来源：拉丁语 urbs（城市）。常进入城市、郊区、城市化。",
    "vac": "来源：拉丁语 vacare（空）。常指空缺、真空、撤空。",
    "ven/vent": "来源：拉丁语 venire（来）。常表示到来、发生、介入、会议聚集。",
    "ver": "来源：拉丁语 verus（真实）。常表示验证、真实、裁决。",
    "vid/vis": "来源：拉丁语 videre（看）。常指视觉、可见、证据。",
    "vit/viv": "来源：拉丁语 vivere（活着）。常进入生命、存活、生动。",
    "voc/vok": "来源：拉丁语 vox/vocare（声音、呼叫）。常指声音、词汇、唤起。",
}


def origin_note(kind: str, morpheme: str, meaning: str) -> str:
    if kind == "root":
        return ROOT_ORIGIN_NOTES.get(
            morpheme,
            f"来源：常见古典词根。先记“{meaning}”这个核心义，再结合前后缀判断词性和方向。",
        )
    if kind == "prefix":
        return f"构词逻辑：前缀放在词前，主要改变方向、数量、否定或程度；这里先按“{meaning}”理解。"
    return f"构词逻辑：后缀放在词尾，主要改变词性、状态或抽象程度；这里先按“{meaning}”判断词类。"
    ...
    return [
        {
            ...
            "memoryTip": tip,
            "originNote": origin_note(kind, morpheme, meaning),
        }
