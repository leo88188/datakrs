(function () {
  ...
  const sentenceWordNotes = {
    abuse: ["滥用；虐待", "常见搭配 abuse of power，表示权力滥用。"],
    accountability: ["问责；责任追究", "常用于政府、企业、AI、公共服务等话题，强调谁需要为后果负责。"],
    accountable: ["需负责的；可问责的", "常用于 institutions、companies、governments，强调责任边界。"],
    adopt: ["采用；采纳", "adopt a policy / technology 表示采用政策或技术。"],
    adopts: ["采用；采纳", "第三人称形式，常用于 society adopts...。"],
    advantage: ["优势；好处", "写作中可用 advantage / drawback 做利弊分析。"],
    advantages: ["优势；好处", "复数形式，常用于 its advantages are...。"],
    aim: ["目标；目的", "clear aims 表示清晰目标，比 goal 更正式一点。"],
    ...
    agriculture: ["农业", "环境、食品安全、乡村发展话题常见，可和 resource use、technology 搭配。"],
    algorithmic: ["算法的；由算法控制的", "平台经济和人工智能话题高频，用于讨论效率、偏见和控制。"],
    anxiety: ["焦虑", "心理健康、青少年压力、工作压力中常用。"],
    apparent: ["表面上的；明显的", "常用于 apparent benefit / apparent problem，提醒未必是真实全貌。"],
    appear: ["显得；出现", "however useful it may appear 表示无论它看起来多么有用。"],
    appears: ["显得；出现", "第三人称形式，常用于 it appears useful。"],
    assessment: ["评价；评估", "学校评价、风险评估、政策评估都可用 assessment。"],
    assumptions: ["假设；成见", "用于表达观点背后的前提，也可批判过时观念。"],
    attention: ["注意力", "学习、媒体、工作和个人成长话题都高频。"],
    automation: ["自动化", "工作、制造、AI 话题常见，常和 productivity、job displacement 连用。"],
    available: ["可获得的；可使用的", "常用于 resources available / services available。"],
    bias: ["偏见；偏差", "AI、招聘、性别平等、媒体话题的核心词。"],
    biotechnology: ["生物技术", "科技、医疗、农业话题中可用，常涉及伦理和公平。"],
    biodiversity: ["生物多样性", "环境高分词，用于生态系统和长期风险。"],
    broader: ["更广泛的", "a broader system 表示更大的系统，适合写作扩展。"],
    budget: ["预算", "政府、家庭、企业、公共服务话题常用。"],
    bureaucracy: ["官僚主义；繁文缛节", "政府效率、公共服务话题常用。"],
    capacity: ["能力；容量", "常指系统、机构或个人能承载多少任务。"],
    charitable: ["慈善的", "charitable giving 指慈善捐助，适合社会责任话题。"],
    choice: ["选择", "human choice 表示人的选择空间。"],
    choices: ["选择", "make wiser choices 表示做出更明智的选择。"],
    citizen: ["公民", "政府、公共服务、公民参与话题常用。"],
    citizens: ["公民", "复数形式，常作为政策影响对象。"],
    civic: ["公民的；市民的", "civic participation 表示公民参与。"],
    climate: ["气候", "climate adaptation / climate change 都是环境话题高频。"],
    complacency: ["自满；麻痹大意", "灾害应对、安全、公共健康中用于说明风险被低估。"],
    compliance: ["合规；遵守规则", "商业、跨境贸易、数据安全中常见。"],
    concern: ["担忧；关切", "public concern 指公众关切。"],
    concerns: ["担忧；关切", "复数形式，常用于 privacy concerns、ethical concerns。"],
    consent: ["同意；许可", "数据隐私、医疗和法律话题中强调知情同意。"],
    consequence: ["后果；影响", "写作中比 result 更正式，可用于因果论证。"],
    consequences: ["后果；影响", "复数形式常用于强调一系列长期影响。"],
    consumer: ["消费者", "消费文化、金融、广告话题高频。"],
    consumers: ["消费者", "复数形式，常作为受影响人群。"],
    consumption: ["消费；消耗", "可用于 consumer culture、energy consumption、water consumption。"],
    convenient: ["方便的", "短期便利和长期风险对比时常用。"],
    coordination: ["协调", "公共服务、灾害应对、供应链话题高频。"],
    corporate: ["企业的；公司的", "corporate responsibility 指企业责任。"],
    corruption: ["腐败", "政府、社会信任、公共资源分配话题常用。"],
    cost: ["成本；代价", "可以是金钱成本，也可以是社会、时间或心理代价。"],
    costs: ["成本；代价", "hidden costs 指隐藏成本。"],
    crisis: ["危机", "公共健康、经济、环境、心理健康都可用。"],
    creativity: ["创造力", "教育、艺术、商业创新话题中常用。"],
    cultural: ["文化的", "cultural heritage / cultural exchange 都是常用搭配。"],
    culture: ["文化；风气", "可指民族文化，也可指 consumer culture、workplace culture。"],
    debate: ["辩论；公共讨论", "public debate 表示公共讨论，适合社会议题。"],
    debt: ["债务", "金融、住房、政府财政话题高频。"],
    define: ["定义；界定", "用于讨论概念边界。"],
    determines: ["决定", "正式表达，比 decides 更适合写作。"],
    dignity: ["尊严", "养老、公共服务、弱势群体话题常用。"],
    disadvantage: ["劣势；不利条件", "社会公平、教育和贫富差距话题常用。"],
    disadvantages: ["劣势；不利条件", "复数形式，可表示多重不利条件。"],
    discrimination: ["歧视", "法律、性别、就业、基因检测话题高频。"],
    discipline: ["自律；纪律", "既可讲个人习惯，也可讲组织管理和社会规则。"],
    discernment: ["辨别力；判断边界", "比 judgment 更强调看清差别、避免盲从。"],
    displacement: ["替代；流离失所", "automation 可导致 job displacement，城市更新也可导致居民迁出。"],
    drawback: ["缺点；不利因素", "比 disadvantage 更口语化一些，写作中也可用。"],
    drawbacks: ["缺点；不利因素", "利弊分析中可和 advantages 对应。"],
    economic: ["经济的", "economic growth / dependence / inequality 都是高频搭配。"],
    efficiency: ["效率", "科技、公共服务、企业管理中常用，但常需要和 fairness 平衡。"],
    efficient: ["高效的", "注意雅思写作中常需要平衡 efficient 和 fair。"],
    empathy: ["同理心", "教育、管理、关系、社会服务中可用。"],
    emissions: ["排放物；排放量", "工业排放、碳排放、空气质量话题高频。"],
    encourage: ["鼓励；促使", "encourage behaviour / participation / innovation 都可用。"],
    encourages: ["鼓励；促使", "第三人称形式，常用于 it encourages...。"],
    enforcement: ["执行；执法", "法律、环保、政策话题高频。"],
    entrepreneurship: ["创业；企业家精神", "商业、就业、创新话题可用。"],
    environment: ["环境", "environmental protection 的基础词。"],
    environmental: ["环境的", "environmental impact / protection / damage 都是高频搭配。"],
    equality: ["平等", "social equality / gender equality 常见。"],
    ethical: ["伦理的；道德的", "AI、科技、医疗、商业中常用于说明边界。"],
    ethics: ["伦理；道德规范", "business ethics 指商业伦理。"],
    evidence: ["证据", "论证和新闻素养中非常重要，用来避免空泛表达。"],
    evaluate: ["评估；评价", "evaluate benefits and risks 表示评估利弊。"],
    excessive: ["过度的", "可修饰 pressure、expectations、screen time、consumption。"],
    exclusion: ["排斥；排除", "社会公平、犯罪预防、移民话题中常用。"],
    expand: ["扩大；扩展", "expand access / opportunities / choices 都是好用搭配。"],
    exploitation: ["剥削；利用", "劳动、平台经济、商业伦理话题中常用。"],
    facilities: ["设施", "public facilities / sports facilities / medical facilities 常见。"],
    fairness: ["公平", "政策、教育、AI、商业话题常用。"],
    fragile: ["脆弱的", "可描述系统、信任、身份、环境。"],
    fragile: ["脆弱的", "可描述系统、信任、身份、环境。"],
    fragility: ["脆弱性", "供应链、社会信任、生态系统话题常见。"],
    framework: ["框架；体系", "可用于 policy framework、legal framework、learning framework。"],
    fundraising: ["募款；筹款", "慈善捐助和社区项目中常见。"],
    gender: ["性别", "gender equality 指性别平等。"],
    gentrification: ["绅士化；旧区改造后原居民被挤出", "城市更新高频词，表达改造带来的社会成本。"],
    globalisation: ["全球化", "英式拼写，常用于文化、贸易、就业和经济依赖。"],
    governance: ["治理", "比 management 更偏公共政策和制度安排。"],
    habit: ["习惯", "habit rather than mood 是可迁移表达。"],
    habits: ["习惯", "daily habits / consumption habits 都很常见。"],
    headline: ["标题；新闻标题", "misleading headlines 指误导性标题。"],
    headlines: ["标题；新闻标题", "新闻素养话题中常见。"],
    heritage: ["遗产；传统", "cultural heritage 指文化遗产。"],
    hidden: ["隐藏的；不易察觉的", "hidden costs / hidden bias 都是高分搭配。"],
    humility: ["谦逊", "用于个人品质，也可用于学习和领导力。"],
    immediate: ["立即的；眼前的", "immediate benefits 与 long-term costs 常形成对比。"],
    impact: ["影响；冲击", "environmental impact / social impact 都常用。"],
    impacts: ["影响；冲击", "复数形式，可表示多个层面的影响。"],
    inclusion: ["包容；纳入", "社会公平、无障碍、教育和职场话题高频。"],
    inclusive: ["包容性的", "常修饰 education、growth、design、policy。"],
    inequality: ["不平等", "收入、教育、地区、数字接入等话题核心词。"],
    infrastructure: ["基础设施", "城市、乡村、交通、公共服务话题高频。"],
    innovation: ["创新", "科技、商业、教育高频词，注意不要只写好处，也要写监管。"],
    inspection: ["检查；监管检查", "食品安全、工程、公共安全话题常见。"],
    institution: ["机构；制度", "可指学校、政府部门、社会制度。"],
    institutions: ["机构；制度", "复数形式，常用于 public institutions。"],
    intellectual: ["知识的；智力的", "intellectual property 指知识产权。"],
    investment: ["投资；投入", "可指金钱投入，也可指教育、基础设施等长期投入。"],
    irreversible: ["不可逆的", "环境、科技风险中非常有力度的词。"],
    judgment: ["判断力；判断", "human judgment 常用于 AI 和技术不能完全替代人的判断。"],
    labour: ["劳动；劳动力", "英式拼写，labour market 指劳动力市场。"],
    legislation: ["立法", "technology regulation 话题中常用。"],
    limited: ["有限的", "limited access / limited resources 都是常用搭配。"],
    literacy: ["素养；读写能力", "news literacy、financial literacy、digital literacy 都是好用搭配。"],
    logistics: ["物流", "供应链、城市配送、跨境贸易话题常用。"],
    "long-term": ["长期的", "写作中常用来和 short-term 对比。"],
    meaningful: ["有意义的；实质性的", "meaningful improvement 指真正有意义的改进。"],
    merely: ["仅仅；只是", "rather than merely... 用来避免表达太绝对。"],
    mobility: ["流动性；移动能力", "social mobility 指社会流动性。"],
    manipulation: ["操控；诱导", "广告、媒体、算法话题中用于表达负面影响。"],
    migration: ["迁移；移民", "社会、就业、城市、国际关系话题常见。"],
    misinformation: ["错误信息；误导性信息", "媒体、公共健康、社会信任高频。"],
    motivation: ["动力；动机", "学习、工作、个人成长话题常用。"],
    municipal: ["市政的", "城市财政、公共服务中常见。"],
    neighbourhood: ["社区；街区", "英式拼写，城市和社区话题常用。"],
    outcome: ["结果；产出", "job outcomes、learning outcomes 都是常见搭配。"],
    outcomes: ["结果；产出", "复数形式，适合讨论政策或教育结果。"],
    overprotection: ["过度保护", "家庭教育、儿童成长话题中常见。"],
    participation: ["参与", "sport participation、civic participation 都是高频搭配。"],
    perspective: ["视角；角度", "from a long-term perspective 是高分表达。"],
    persuasion: ["说服；劝导", "媒体、广告、公共讨论中常用。"],
    policy: ["政策", "government policy、tax policy、public policy 都常见。"],
    polarisation: ["极化；对立加剧", "公共舆论、政治和社会信任话题高频。"],
    poverty: ["贫困", "犯罪预防、社会公平、国际援助中常用。"],
    practical: ["实际的；实用的", "practical support / practical solutions 都很好用。"],
    praised: ["被称赞；被表扬", "be praised for... 表示因某事受到称赞。"],
    preserve: ["保护；保存", "preserve culture / resources / dignity 都可用。"],
    preserving: ["保护；保存", "动名词形式，常用于 arts funding 和文化话题。"],
    privacy: ["隐私", "科技、AI、数据安全话题核心词。"],
    provision: ["供给；提供", "public service provision 指公共服务供给。"],
    productivity: ["生产率；生产力", "自动化、远程办公、职场话题高频。"],
    proportion: ["比例；分寸", "a sense of proportion 指分寸感，适合表达冷静判断。"],
    protection: ["保护", "data protection、labour protection、environmental protection 都常用。"],
    public: ["公共的；公众的", "public services、public debate、public health 都高频。"],
    punishment: ["惩罚", "犯罪预防、教育、法律话题常用。"],
    raise: ["提高；提出", "raise productivity / raise concern 都可用。"],
    realistic: ["现实的；可实现的", "make goals more realistic 表示让目标更可落地。"],
    recycling: ["回收利用", "垃圾治理、循环经济、环境话题高频。"],
    regulation: ["监管；规则", "科技、金融、平台经济、环保话题常用。"],
    reliable: ["可靠的", "可描述 information、person、system、service。"],
    resilience: ["韧性；恢复力", "个人、社区、供应链、生态系统都可以用。"],
    resources: ["资源", "环境、教育、公共服务和企业管理中常见。"],
    responsibility: ["责任", "个人品质、企业责任、政府责任都可用。"],
    restraint: ["克制；节制", "比 self-control 更正式，适合写作观点句。"],
    retirees: ["退休人员", "养老、志愿服务和社区话题中常见。"],
    scarcity: ["稀缺；短缺", "住房、水资源、能源和教育资源话题常用。"],
    shallow: ["浅层的；肤浅的", "shallow learning 表示浅层学习。"],
    shortage: ["短缺", "staff shortages / housing shortage / water shortage 都可用。"],
    shortages: ["短缺", "复数形式，常表示多方面供应不足。"],
    social: ["社会的", "social equality / social trust / social mobility 都常见。"],
    society: ["社会", "写作中常用 broad term，用来上升到社会层面。"],
    solution: ["解决方案", "注意写作中可以强调 not a simple solution。"],
    specialised: ["专业化的；专门的", "英式拼写，常用于 specialised knowledge / production。"],
    speculation: ["投机；推测", "金融、住房、市场话题中常见。"],
    stigma: ["污名；羞耻标签", "心理健康、疾病、弱势群体话题高频。"],
    substitute: ["替代品；替代", "as a substitute for... 表示作为某物的替代。"],
    surveillance: ["监控；监视", "数据隐私、政府、科技监管话题常用。"],
    sustainable: ["可持续的", "环境、建筑、发展、消费话题核心词。"],
    systems: ["系统；体系", "public systems、AI systems、support systems 都常见。"],
    tension: ["紧张关系；矛盾", "political tension、social tension 都常用。"],
    taxation: ["税收", "政府、福利、公共服务和贫富差距话题常见。"],
    technology: ["技术", "科技、教育、工作、隐私等话题中最基础的核心词。"],
    temptation: ["诱惑；冲动", "用于自律、消费、拖延等个人或社会行为。"],
    transparency: ["透明度", "政府、慈善、企业责任、AI 决策中常用。"],
    uncertainty: ["不确定性", "经济、科技、个人选择、创业话题常用。"],
    uneven: ["不均衡的；不平等的", "uneven access / uneven investment 都适合写作。"],
    uncertainty: ["不确定性", "经济、科技、个人选择、创业话题常用。"],
    undervalue: ["低估", "艺术、照护、公共服务价值讨论中常用。"],
    useful: ["有用的；实用的", "看似简单，但在观点句中常用于判断实际价值。"],
    value: ["价值", "real value / long-term value 是高频搭配。"],
    visible: ["可见的；明显的", "visible problems 与 hidden costs 可以形成对比。"],
    volatility: ["波动性", "能源价格、金融市场话题常用。"],
    vulnerable: ["脆弱的；弱势的", "vulnerable groups 指弱势群体。"],
    whereas: ["然而；而", "正式对比连接词，适合写作复杂句。"],
    accessibility: ["可及性；无障碍程度", "医疗、教育、交通、数字服务都可以讨论 accessibility。"],
    accessible: ["可获得的；无障碍的", "常用于 accessible education、accessible transport、accessible healthcare。"],
    allocation: ["分配；配置", "resource allocation 指资源配置，适合政府和企业话题。"],
    ambition: ["雄心；目标追求", "technological ambition / personal ambition 都可用。"],
    authority: ["权威；主管机构", "public authority 指公共机构或主管部门。"],
    authorities: ["主管部门；当局", "local authorities 指地方政府或地方管理部门。"],
    carbon: ["碳；碳排放相关", "carbon emissions / carbon footprint 是环境话题高频搭配。"],
    catalogue: ["目录；清单", "digital catalogue 指数字目录，公共图书馆场景常见。"],
    catalogues: ["目录；清单", "英式复数拼写，常用于图书馆和数据管理。"],
    cognitive: ["认知的", "cognitive development / cognitive ability 是教育和心理话题高频词。"],
    collaboration: ["协作；合作", "workplace、education、technology projects 中常用。"],
    commercialisation: ["商业化", "文化遗产、旅游、艺术资助中常用于讨论过度商业化。"],
    competitiveness: ["竞争力", "business competitiveness / national competitiveness 都常见。"],
    curriculum: ["课程体系", "教育话题高频词，比 course 更偏制度和学校层面。"],
    demographic: ["人口结构的", "demographic change 表示人口结构变化。"],
    dependency: ["依赖；依赖性", "technology dependency、aid dependency 都是高频表达。"],
    digitalisation: ["数字化", "企业、公共服务、教育和医疗场景常见。"],
    diversity: ["多样性", "文化、职场、生态、教育话题都可用。"],
    ecological: ["生态的", "ecological balance / ecological damage 是环境话题高频表达。"],
    ecosystem: ["生态系统", "自然生态或商业生态都可用。"],
    ecosystems: ["生态系统", "复数形式，常用于 biodiversity protection。"],
    empirical: ["实证的；基于证据的", "academic writing 中可用于 empirical evidence。"],
    expenditure: ["支出；开支", "public expenditure 指公共支出，金融和政府话题常见。"],
    expertise: ["专业能力；专业知识", "medical expertise / technical expertise 都常用。"],
    export: ["出口", "跨境贸易、制造业、经济话题常见。"],
    exporters: ["出口商", "跨境贸易语境中常见。"],
    externality: ["外部性", "经济学专业词，指成本或收益影响到交易之外的人。"],
    externalities: ["外部性", "环境污染和公共政策话题可用。"],
    fossil: ["化石的", "fossil fuels 指化石燃料。"],
    fuels: ["燃料", "fossil fuels / renewable fuels 都是能源话题词。"],
    funding: ["资金；资助", "arts funding、research funding、public funding 都高频。"],
    generation: ["一代人；产生", "younger generation / future generations 常见。"],
    generations: ["世代；几代人", "future generations 是环境和教育话题高频表达。"],
    healthcare: ["医疗保健", "公共健康和医疗服务话题常见。"],
    hypothesis: ["假设；假说", "科学研究和学术论证中常用。"],
    implication: ["影响；含义；潜在后果", "policy implications / social implications 是写作高分表达。"],
    implications: ["影响；含义；潜在后果", "复数形式，适合讨论多层后果。"],
    industrial: ["工业的；产业的", "industrial emissions / industrial production 都常见。"],
    inequality: ["不平等", "收入、教育、地区、数字接入等话题核心词。"],
    inflation: ["通货膨胀", "金融、生活成本、经济政策话题高频。"],
    integration: ["融合；融入", "migration integration、system integration 都可用。"],
    interdisciplinary: ["跨学科的", "教育、科研、创新话题中较高级。"],
    intervention: ["干预；介入措施", "government intervention、early intervention 都常用。"],
    investor: ["投资者", "金融、创业和市场话题常见。"],
    investors: ["投资者", "复数形式，常作为市场参与者。"],
    livelihood: ["生计", "农业、乡村、就业、灾害话题常用。"],
    market: ["市场", "market power / market failure / labour market 都高频。"],
    monopoly: ["垄断", "商业竞争、平台经济、知识产权话题常用。"],
    monopolies: ["垄断", "复数形式，常用于讨论市场竞争不足。"],
    outcome: ["结果；产出", "learning outcome、policy outcome、job outcome 都常见。"],
    pedagogical: ["教学法的；教育方法的", "教育话题专业词，适合讨论教学方式。"],
    phenomenon: ["现象", "social phenomenon / economic phenomenon 是写作常用词。"],
    preventive: ["预防性的", "preventive healthcare / preventive measures 都常见。"],
    procurement: ["采购；采购流程", "企业、政府、供应链话题专业词。"],
    renewable: ["可再生的", "renewable energy 是能源转型高频表达。"],
    revenue: ["收入；财政收入", "企业营收或政府财政收入都可用。"],
    stakeholder: ["利益相关者", "政策、企业、项目管理话题高频词。"],
    stakeholders: ["利益相关者", "复数形式，常用于各方共同影响的复杂问题。"],
    subsidy: ["补贴", "政府政策、能源、农业、公共交通话题常用。"],
    subsidies: ["补贴", "复数形式，常用于政府支出和市场干预。"],
    tariff: ["关税", "跨境贸易、全球化话题常见。"],
    tariffs: ["关税", "复数形式，常用于 trade barriers。"],
    threshold: ["门槛；临界点", "可用于 policy threshold、income threshold、risk threshold。"],
    urbanisation: ["城市化", "英式拼写，城市发展和住房话题高频。"],
    welfare: ["福利；福祉", "welfare system 指福利制度，也可指 wellbeing。"],
    workforce: ["劳动力；员工队伍", "automation、remote work、skills training 中常用。"],
    wellbeing: ["幸福感；身心健康", "教育、工作、家庭和公共健康中常见。"],
    wiser: ["更明智的", "make wiser choices 是非常自然的表达。"],
  };
  ...
  Object.assign(sentenceWordNotes, {
    ...
    adolescence: ["青春期；青少年阶段", "教育、心理健康和家庭话题中较正式。"],
    advocate: ["倡导；支持者", "既可作动词也可作名词，用于政策和社会议题。"],
    advocates: ["倡导者；主张者", "常用于 some advocates argue that...。"],
    agenda: ["议程；待解决事项", "policy agenda / public agenda 都可用于社会话题。"],
    agricultural: ["农业的", "agricultural production / agricultural policy 都常见。"],
    alternative: ["替代选择；替代的", "alternative energy / alternative approach 是常用搭配。"],
    ambiguous: ["模糊的；有歧义的", "可用于 rules、data、evidence 不清楚的场景。"],
    analysis: ["分析", "data analysis / cost-benefit analysis 都是高频。"],
    analytical: ["分析型的；善于分析的", "analytical thinking 适合教育和工作话题。"],
    artificial: ["人工的；人造的", "artificial intelligence 指人工智能。"],
    aspiration: ["抱负；愿望", "educational aspiration / career aspiration 常见。"],
    audit: ["审计；审核", "data audit、financial audit、AI audit 都可用。"],
    autonomy: ["自主权；自主性", "worker autonomy / student autonomy 是高分表达。"],
    availability: ["可获得性；供应情况", "availability of resources/services 表示资源或服务是否可获得。"],
    barrier: ["障碍；壁垒", "structural barrier / trade barrier / language barrier 常见。"],
    barriers: ["障碍；壁垒", "复数形式，常用于社会公平和贸易话题。"],
    behaviour: ["行为", "英式拼写，consumer behaviour、social behaviour 都高频。"],
    behavioural: ["行为的", "behavioural change 指行为改变，环境和健康话题常见。"],
    benefit: ["好处；利益", "可作名词或动词，写作中注意不要只列 benefits。"],
    benefits: ["好处；利益", "复数形式，常与 costs、risks 对比。"],
    boundary: ["边界", "ethical boundary、personal boundary、policy boundary 都可用。"],
    boundaries: ["边界", "复数形式，常用于隐私、职场、关系和技术监管。"],
    campaign: ["活动；运动", "public campaign / advertising campaign 常见。"],
    campaigns: ["活动；运动", "复数形式，常用于公共宣传或营销。"],
    capability: ["能力；性能", "AI capability / organisational capability 都可用。"],
    catalyst: ["催化因素；促成因素", "可用于说明某事加速变化。"],
    centralised: ["集中化的", "centralised system 表示集中式系统。"],
    challenge: ["挑战", "常见基础词，但写作中可替换 problem。"],
    challenges: ["挑战", "复数形式，常用于 topic sentence。"],
    characteristic: ["特征；特点", "可用于描述群体、制度或技术特点。"],
    characteristics: ["特征；特点", "复数形式，适合分类描述。"],
    childcare: ["儿童照护；托育", "家庭、工作、性别平等话题高频。"],
    circumstance: ["情况；环境", "under certain circumstances 表示在某些情况下。"],
    circumstances: ["情况；环境", "复数形式，写作中比 situation 更正式。"],
    cohesion: ["凝聚力；连贯性", "social cohesion 指社会凝聚力；写作评分也有 cohesion。"],
    commerce: ["商业；贸易", "e-commerce 是电子商务，cross-border commerce 是跨境商业。"],
    commodity: ["商品；大宗商品", "经济、贸易、消费话题常见。"],
    commodities: ["商品；大宗商品", "复数形式，常用于全球贸易和价格波动。"],
    communicate: ["沟通；传达", "写作中常用于 institutions communicate clearly。"],
    communication: ["沟通；传播", "职场、媒体、教育、科技话题高频。"],
    community: ["社区；群体", "local community、online community 都常用。"],
    communities: ["社区；群体", "复数形式，常作为政策影响对象。"],
    comparison: ["比较；攀比", "social comparison 常用于社交媒体和心理健康。"],
    complexity: ["复杂性", "the complexity of... 是高分抽象表达。"],
    compound: ["复合的；加剧", "可用于 compound pressure 表示叠加压力。"],
    compromise: ["妥协；折中方案", "policy compromise / compromise privacy 都可用。"],
    concentration: ["专注；集中", "学习、工作、城市集中化话题都可用。"],
    conservation: ["保护；保存", "wildlife conservation / energy conservation 都是环境高频。"],
    conservative: ["保守的；保守派的", "也可指 conservative estimate 保守估计。"],
    constrain: ["限制；约束", "用于说明资源、规则、时间对选择的限制。"],
    constraint: ["限制；约束条件", "financial constraint / time constraint 常见。"],
    constraints: ["限制；约束条件", "复数形式，常用于现实条件分析。"],
    consultation: ["咨询；征询意见", "public consultation 是政策制定常见流程。"],
    consultations: ["咨询；征询意见", "复数形式，常用于 civic participation。"],
    context: ["语境；背景", "fragmented context 指碎片化语境。"],
    contradict: ["反驳；相矛盾", "academic writing 中用于观点冲突。"],
    controversy: ["争议", "social controversy / ethical controversy 常见。"],
    controversial: ["有争议的", "常修饰 policy、technology、issue。"],
    cooperation: ["合作", "international cooperation / workplace cooperation 都高频。"],
    creativity: ["创造力", "教育、艺术、商业创新话题中常用。"],
    credible: ["可信的", "credible evidence / credible source 是新闻素养高频。"],
    criterion: ["标准；准则", "单数形式，复数是 criteria。"],
    criteria: ["标准；准则", "assessment criteria 表示评价标准。"],
    critical: ["关键的；批判性的", "critical thinking 指批判性思维。"],
    cultivate: ["培养", "cultivate skills / habits / awareness 都可用。"],
    cumulative: ["累积的", "cumulative effect 表示累积影响。"],
    cyber: ["网络的；数字安全相关", "cyber risk / cyber security 常见。"],
    cybersecurity: ["网络安全", "数据保护和企业安全话题专业词。"],
    database: ["数据库", "技术、数据安全、企业系统场景常用。"],
    decline: ["下降；衰退", "population decline / economic decline / decline in use 都常见。"],
    decentralised: ["去中心化的；分散式的", "技术、治理和能源话题可用。"],
    deficit: ["赤字；不足", "budget deficit 指财政赤字，也可表示能力不足。"],
    degradation: ["退化；恶化", "environmental degradation 是环境写作高频。"],
    deliberate: ["深思熟虑的；故意的", "deliberate practice 指刻意练习。"],
    demand: ["需求；要求", "market demand / public demand 都高频。"],
    dependency: ["依赖；依赖性", "technology dependency、aid dependency 都是高频表达。"],
    deprived: ["贫困的；被剥夺的", "deprived communities 指资源不足社区。"],
    design: ["设计；规划", "policy design、system design、urban design 都可用。"],
    deterioration: ["恶化", "health deterioration / environmental deterioration 常见。"],
    diagnostic: ["诊断的；诊断工具", "medical diagnostic / diagnostic report 都可用。"],
    dilemma: ["困境；两难", "ethical dilemma 是科技和医疗话题高频。"],
    dimension: ["维度；方面", "social dimension / economic dimension 适合扩展论证。"],
    diminish: ["减少；削弱", "diminish trust / diminish motivation 都可用。"],
    disclosure: ["披露；公开", "financial disclosure / data disclosure 常见。"],
    distribution: ["分配；分布", "income distribution / resource distribution 都高频。"],
    diverse: ["多样的", "diverse backgrounds / diverse cultures 常见。"],
    domestic: ["国内的；家庭的", "domestic market、domestic responsibility 都可用。"],
    dominant: ["占主导的", "dominant media / dominant culture / dominant company 常见。"],
    economy: ["经济；经济体", "market economy、circular economy 都高频。"],
    ecosystem: ["生态系统", "自然生态或商业生态都可用。"],
    element: ["要素；元素", "key element 指关键要素。"],
    eligible: ["符合条件的", "eligible for subsidy / welfare / support 常见。"],
    emission: ["排放", "carbon emission / industrial emission 是环境高频。"],
    employability: ["就业能力", "教育、职业培训话题专业词。"],
    employment: ["就业；雇佣", "employment opportunity / employment rate 都常用。"],
    empower: ["赋能；使有能力", "empower citizens / students / workers 常见。"],
    enables: ["使能够；让……成为可能", "technology enables... 是常见句型。"],
    enhancement: ["提升；增强", "skill enhancement / productivity enhancement 都可用。"],
    enterprise: ["企业", "enterprise system / enterprise training 常见。"],
    equity: ["公平；权益", "教育公平、医疗公平中比 equality 更强调按需分配。"],
    erosion: ["侵蚀；削弱", "trust erosion / soil erosion 都可用。"],
    essential: ["必要的；本质的", "essential service / essential skill 常见。"],
    estimate: ["估计；估算", "rough estimate / conservative estimate 都可用。"],
    evaluate: ["评估；评价", "evaluate benefits and risks 表示评估利弊。"],
    exposure: ["暴露；接触", "media exposure、risk exposure、language exposure 都常见。"],
    facilitate: ["促进；便利", "facilitate communication / trade / learning 是高分动词。"],
    factor: ["因素", "key factor / contributing factor 都高频。"],
    feasibility: ["可行性", "policy feasibility / technical feasibility 常见。"],
    flexible: ["灵活的", "flexible work / flexible learning 都高频。"],
    fluency: ["流利度", "口语能力、语言学习话题常用。"],
    fundamental: ["根本的；基础的", "fundamental right / fundamental problem 都可用。"],
    generate: ["产生；生成", "generate income / generate data / generate ideas 都常见。"],
    habitat: ["栖息地", "环境和生物多样性话题高频。"],
    holistic: ["整体的；全面的", "holistic approach 指整体方法。"],
    incentive: ["激励；动机", "financial incentive / policy incentive 常用。"],
    incentives: ["激励；动机", "复数形式，常用于经济和政策话题。"],
    incidence: ["发生率", "crime incidence / disease incidence 较专业。"],
    indicator: ["指标", "economic indicator / performance indicator 都可用。"],
    indicators: ["指标", "复数形式，用于衡量复杂问题。"],
    inevitable: ["不可避免的", "常用于 technology change、urbanisation 等趋势。"],
    inform: ["告知；影响", "inform decisions 表示为决策提供信息。"],
    informed: ["知情的；有依据的", "informed choice / informed decision 是高频表达。"],
    initiative: ["倡议；主动性", "public initiative、business initiative 都可用。"],
    institutional: ["制度的；机构的", "institutional trust / institutional support 常见。"],
    interoperability: ["互操作性；系统兼容性", "技术和企业系统专业词。"],
    interpret: ["解释；解读", "interpret data / evidence / results 都常见。"],
    interpretation: ["解释；解读", "data interpretation、legal interpretation 都可用。"],
    investment: ["投资；投入", "可指金钱投入，也可指教育、基础设施等长期投入。"],
    isolate: ["隔离；孤立", "social isolation / isolate a problem 都可用。"],
    legitimacy: ["合法性；正当性", "policy legitimacy / institutional legitimacy 常见。"],
    limitation: ["限制；局限", "method limitation / policy limitation 都常见。"],
    literacy: ["素养；读写能力", "news literacy、financial literacy、digital literacy 都是好用搭配。"],
    mechanism: ["机制", "market mechanism / feedback mechanism / consent mechanism 常用。"],
    metropolitan: ["大都市的", "metropolitan area 指大都市地区。"],
    monitor: ["监测；监督", "monitor emissions / performance / health data 都可用。"],
    negotiation: ["谈判；协商", "trade negotiation / labour negotiation 常见。"],
    obesity: ["肥胖", "公共健康和生活方式话题高频。"],
    objective: ["目标；客观的", "可作名词，也可作形容词 objective evidence。"],
    obsolete: ["过时的；淘汰的", "obsolete skills / obsolete technology 常见。"],
    occupation: ["职业；占用", "职业话题中比 job 更正式。"],
    operational: ["运营的；操作层面的", "operational cost / operational efficiency 常见。"],
    opportunity: ["机会", "opportunity gap / equal opportunity 都高频。"],
    optimise: ["优化", "英式拼写，optimise resources / systems / performance。"],
    outsourcing: ["外包", "商业、全球化、就业话题常见。"],
    participatory: ["参与式的", "participatory governance 表示参与式治理。"],
    perception: ["感知；看法", "public perception / risk perception 都常见。"],
    persistent: ["持续存在的；顽固的", "persistent inequality / persistent pressure 常用。"],
    platform: ["平台", "digital platform / platform economy 都高频。"],
    pollution: ["污染", "空气、水、噪音、垃圾治理都高频。"],
    poverty: ["贫困", "犯罪预防、社会公平、国际援助中常用。"],
    predictable: ["可预测的", "predictable rules / predictable outcomes 常见。"],
    privacy: ["隐私", "科技、AI、数据安全话题核心词。"],
    productivity: ["生产率；生产力", "自动化、远程办公、职场话题高频。"],
    professional: ["专业的；职业的", "professional training / professional standards 常见。"],
    protocol: ["协议；流程", "technical protocol / safety protocol 都可用。"],
    recession: ["经济衰退", "经济、就业、政府政策话题高频。"],
    reinforce: ["强化；加固", "reinforce inequality / reinforce habits 都可用。"],
    relevance: ["相关性；现实意义", "practical relevance 表示实际相关性。"],
    remedy: ["补救措施；解决办法", "policy remedy / legal remedy 都可用。"],
    reputation: ["声誉", "corporate reputation / personal reputation 常见。"],
    requirement: ["要求；条件", "legal requirement / entry requirement 都常用。"],
    requirements: ["要求；条件", "复数形式，常用于合规和教育。"],
    research: ["研究", "scientific research / market research 都高频。"],
    resistance: ["阻力；抵抗", "social resistance / resistance to change 常见。"],
    retention: ["留存；保持", "memory retention、employee retention 都可用。"],
    risk: ["风险", "risk management、health risk、financial risk 都高频。"],
    routine: ["日常惯例；例行程序", "daily routine / work routine 常见。"],
    scarcity: ["稀缺；短缺", "住房、水资源、能源和教育资源话题常用。"],
    sector: ["行业；部门", "public sector / private sector 都高频。"],
    sectors: ["行业；部门", "复数形式，常用于经济结构。"],
    simulate: ["模拟", "technology、training、science 话题可用。"],
    simulation: ["模拟；仿真", "training simulation / computer simulation 常见。"],
    sophisticated: ["复杂精密的；高级的", "sophisticated system / argument / method 都可用。"],
    stability: ["稳定性", "economic stability、social stability、emotional stability 常见。"],
    standardise: ["标准化", "英式拼写，适合教育、制造、流程话题。"],
    strategy: ["策略；战略", "business strategy、learning strategy 都高频。"],
    structural: ["结构性的", "structural barrier / structural inequality 是高分表达。"],
    subsidy: ["补贴", "政府政策、能源、农业、公共交通话题常用。"],
    supply: ["供应；供给", "supply chain、housing supply、water supply 都高频。"],
    sustainability: ["可持续性", "环境、企业责任、城市发展高频抽象名词。"],
    technical: ["技术的；专业的", "technical skills / technical standards 常见。"],
    transform: ["转变；改造", "transform services / industries / habits 都可用。"],
    transition: ["转型；过渡", "energy transition、career transition 都高频。"],
    unemployment: ["失业", "经济、自动化、教育和社会稳定话题高频。"],
    upgrade: ["升级；改善", "system upgrade / skill upgrade 都可用。"],
    urban: ["城市的", "urban development / urban finance / urban renewal 都高频。"],
    validity: ["有效性；合理性", "research validity / legal validity 常见。"],
    viable: ["可行的；能存活的", "viable solution / viable business model 都可用。"],
    adversity: ["逆境；不利处境", "个人成长、社会流动、教育机会话题常用。"],
    affection: ["喜爱；情感", "关系、家庭、教育中可用于表达温暖但正式的情感。"],
    apprentice: ["学徒；学习者", "可引申为向优秀对象学习的人。"],
    apprenticeship: ["学徒期；学习过程", "replace envy with apprenticeship 表示把嫉妒转化为学习。"],
    applause: ["掌声；认可", "可用于讨论外部认可和内在动机。"],
    aspiration: ["抱负；愿望", "career aspiration、educational aspiration 都常见。"],
    beginner: ["初学者", "make peace with being a beginner again 是学习话题好句。"],
    barrenness: ["贫瘠；空洞", "常用于比喻精神或生活内容的贫乏。"],
    biography: ["传记；人生记录", "Your calendar is a biography... 是很有画面感的表达。"],
    bold: ["大胆的；勇敢的", "bold choice / bold action 常用于 courage 话题。"],
    borrowed: ["借来的；外来的", "borrowed urgency 指来自他人的紧急感。"],
    brevity: ["简洁；简明", "Brevity is the soul of wit 是经典表达。"],
    buffer: ["缓冲", "也可用于技术和幽默表达，表示暂时还没准备好。"],
    cinematic: ["电影感的；像电影一样的", "用于生活、期待和叙事类表达。"],
    clarity: ["清晰；清醒", "clarity 是表达、思考和决策的高频抽象名词。"],
    commitment: ["承诺；投入", "长期目标、关系、工作和学习都可用。"],
    comparison: ["比较；攀比", "social comparison 常用于社交媒体和心理健康。"],
    convincing: ["有说服力的", "comfort stops being convincing 表示舒适区不再能说服你。"],
    courage: ["勇气", "可用于人物品质、选择和挑战话题。"],
    curiosity: ["好奇心", "教育、科学、学习动机话题高频。"],
    deadline: ["截止日期", "学习、工作、时间管理话题常见。"],
    deadlines: ["截止日期", "复数形式，常用于工作压力。"],
    decorate: ["装饰；美化", "decorate confusion 表示用好看的说法掩盖困惑。"],
    decorating: ["装饰；美化", "动名词形式，常用于隐喻表达。"],
    destination: ["目的地；目标", "journey / destination 是常见抽象表达。"],
    devotion: ["投入；热爱；奉献", "比 passion 更稳定，适合长期主义和学习话题。"],
    direction: ["方向", "without losing direction 表示不失去方向。"],
    disappointment: ["失望", "个人韧性、心理健康、成长话题常用。"],
    distraction: ["分心；干扰", "constant distraction 是现代学习和工作高频问题。"],
    envy: ["嫉妒", "个人成长和社会比较话题可用。"],
    evidence: ["证据；证明", "既可用于学术论证，也可用于人生表达中的 evidence of strength。"],
    excuse: ["借口", "perfect excuse / convenient excuse 都常见。"],
    excuses: ["借口", "复数形式，用于行动、自律、责任话题。"],
    fatigue: ["疲惫；疲劳", "work fatigue / decision fatigue 都是高频表达。"],
    flaw: ["缺陷；弱点", "讨论制度、人格、设计缺陷时可用。"],
    fragile: ["脆弱的", "可描述系统、信任、身份、环境。"],
    freedom: ["自由", "常用于 personal freedom、economic freedom、academic freedom。"],
    genius: ["天才；天赋", "经典名言和教育话题中常见。"],
    grace: ["优雅；从容", "grace under pressure 表示压力下的从容。"],
    harvest: ["收获；成果", "常用于努力和长期主义的隐喻。"],
    hesitation: ["犹豫", "decision-making、courage、opportunity 话题常见。"],
    honest: ["诚实的；真实的", "honest sentence / honest feedback 都常用。"],
    honesty: ["诚实；真实", "人格品质和沟通话题高频。"],
    hope: ["希望", "可用于个人、社会和环境话题。"],
    impatience: ["不耐烦；急躁", "现代速度压力和长期主义话题常用。"],
    imaginative: ["有想象力的", "创造力、教育和艺术话题常用。"],
    insight: ["洞察力", "比 idea 更高级，强调看见本质。"],
    intention: ["意图；打算", "good intention 表示好意，policy intention 表示政策意图。"],
    kindness: ["善意；仁慈", "关系、社会支持、教育话题可用。"],
    lantern: ["灯笼；指引之光", "比喻用法，表示在混乱中提供方向。"],
    maintenance: ["维护；保养", "rest as maintenance 是健康和效率话题好表达。"],
    maturity: ["成熟", "个人成长、责任、判断力话题可用。"],
    meaningful: ["有意义的；实质性的", "meaningful improvement 指真正有意义的改进。"],
    motive: ["动机", "hidden motive 表示隐藏动机。"],
    motives: ["动机", "复数形式，常用于信任和商业伦理。"],
    negotiate: ["协商；谈判", "也可隐喻为和恐惧、困难谈判。"],
    negotiating: ["协商；谈判", "动名词形式，常用于过程描述。"],
    ordinary: ["普通的；平常的", "ordinary moments / ordinary work 常用于把抽象落到生活。"],
    permanent: ["持久的；永久的", "permanent progress / permanent damage 都可用。"],
    permission: ["许可；允许", "stop asking fear for permission 是很好的隐喻表达。"],
    persuasive: ["有说服力的", "也可幽默地描述 sofa is persuasive。"],
    potential: ["潜力；可能性", "human potential、rural potential、market potential 都高频。"],
    practical: ["实际的；实用的", "practical support / practical solutions 都很好用。"],
    promise: ["承诺；许诺", "promises to yourself 指对自己的承诺。"],
    promises: ["承诺；许诺", "复数形式，常用于责任和信任。"],
    refuge: ["避难所；庇护", "也可比喻为心理退路。"],
    repetition: ["重复", "学习、习惯、训练话题常用。"],
    reliable: ["可靠的", "可描述 information、person、system、service。"],
    rest: ["休息；其余部分", "rest as maintenance 表示休息是一种维护。"],
    routine: ["日常惯例；例行程序", "daily routine / work routine 常见。"],
    shrink: ["缩小；退缩", "refuse to shrink 表示拒绝让自己变小。"],
    simplicity: ["简单；简洁", "simplicity is sophistication 是经典表达。"],
    sophistication: ["精致；复杂高级", "ultimate sophistication 表示终极高级。"],
    soul: ["灵魂；精神核心", "quote 和文学表达中常见。"],
    verdict: ["判决；定论", "mistakes as maps, not verdicts 是很好的隐喻。"],
    verdicts: ["判决；定论", "复数形式，用于不把错误当最终结论。"],
    worthwhile: ["值得的", "adventure is worthwhile 是经典表达。"],
    wounds: ["伤口；创伤", "turn wounds into wisdom 表示把痛苦转化为智慧。"],
    wit: ["机智；幽默感", "the soul of wit 指机智的核心。"],
    wisdom: ["智慧", "比 knowledge 更强调判断和人生理解。"],
  });

  Object.assign(sentenceWordNotes, {
    able: ["能够的；有能力的", "be able to do 比 can 更正式一点，写作和口语都常用。"],
    absence: ["缺席；缺乏", "the absence of... 表示缺少某物。"],
    accept: ["接受", "accept responsibility / accept a cost 都是常用搭配。"],
    accepted: ["接受了的；被认可的", "has accepted a direction/cost 表示已经承担某种方向或代价。"],
    action: ["行动；措施", "planned action、policy action、take action 都高频。"],
    actions: ["行动；措施", "复数形式，常指一组具体做法。"],
    actually: ["实际上", "用于纠正表面判断，接近 in fact。"],
    adult: ["成年人", "public health、work、family 话题常见。"],
    adults: ["成年人", "复数形式，常作为政策或社会影响对象。"],
    alert: ["警惕的；警觉的", "remain alert to risk 表示对风险保持警惕。"],
    allowing: ["允许；使能够", "allowing people to... 常用于说明某事带来的机会。"],
    alone: ["仅仅；独自", "not by speed alone 表示不只靠速度。"],
    although: ["虽然；尽管", "让步状语从句引导词，雅思写作非常高频。"],
    answer: ["答案；回应", "也可作动词，answer a question / answer a need。"],
    appear: ["显得；出现", "however useful it may appear 表示无论它看起来多么有用。"],
    argument: ["论点；争论", "写作中 argument 指论证，不只是吵架。"],
    arise: ["出现；产生", "problems arise when... 是写作常用句型。"],
    assess: ["评估", "assess risks / assess progress 比 check 更正式。"],
    aware: ["意识到的", "be aware of... 表示意识到某事。"],
    awareness: ["意识；认知", "public awareness / risk awareness 常见。"],
    basic: ["基本的", "basic dignity / basic services / basic needs 都常用。"],
    become: ["变成；成为", "become obvious / become necessary 是常用表达。"],
    becomes: ["变成；成为", "第三人称形式，句库里非常常见。"],
    belief: ["信念；看法", "differences in belief 表示信念差异。"],
    beliefs: ["信念；看法", "复数形式，常用于文化、社会、宗教话题。"],
    better: ["更好的", "better choices / better decisions / better outcomes 都常用。"],
    borrow: ["借用", "也可引申为 borrowed urgency 来自他人的紧急感。"],
    bridge: ["桥；桥梁", "常作隐喻，表示连接差异、关系或思想。"],
    careful: ["谨慎的；细致的", "careful human judgment 是技术话题常用表达。"],
    centre: ["中心；核心", "英式拼写，相当于 center。"],
    change: ["变化；改变", "sudden change、social change、behavioural change 都高频。"],
    changing: ["变化中的", "the changing workplace 表示不断变化的职场。"],
    clear: ["清晰的", "clear rules / clear aims / clear evidence 都常用。"],
    clearly: ["清楚地", "communicate clearly 表示清晰沟通。"],
    closer: ["更接近的", "bring people closer to... 表示让人更接近机会或服务。"],
    complex: ["复杂的", "complex task / complex problem / complex system 都高频。"],
    complexity: ["复杂性", "the complexity of... 是高分抽象表达。"],
    condition: ["条件；状况", "the first condition of... 表示某事的第一条件。"],
    conditions: ["条件；状况", "复数形式，常用于 social conditions / working conditions。"],
    connect: ["连接", "connect people / markets / ideas 都常见。"],
    connecting: ["连接", "动名词形式，常用于全球化、平台经济、交通等话题。"],
    contribute: ["贡献；导致", "contribute to a problem 可表示造成问题的一部分。"],
    conventional: ["传统的；常规的", "conventional wisdom / conventional method 都常见。"],
    costly: ["昂贵的；代价高的", "比 expensive 更可用于抽象代价。"],
    crowded: ["拥挤的", "crowded cities / crowded mind 都可用。"],
    customer: ["客户；顾客", "商业、服务、营销话题高频。"],
    customers: ["客户；顾客", "复数形式，常作为企业服务对象。"],
    damage: ["损害；破坏", "environmental damage / soil damage 都常用。"],
    daily: ["每日的；日常的", "daily life / daily routines 都是雅思基础高频。"],
    deal: ["处理；应对", "deal with pressure/problems 是口语高频。"],
    decision: ["决定；决策", "make a decision / policy decision 都常见。"],
    decisions: ["决定；决策", "复数形式，句库里非常常见。"],
    decline: ["下降；衰退", "declining daily use 表示日常使用下降。"],
    deeply: ["深深地；深入地", "the more deeply... enters... 是复杂句高频副词。"],
    depend: ["取决于；依赖", "depend on 是雅思写作核心表达。"],
    depends: ["取决于；依赖", "第三人称形式，its value depends on... 很常用。"],
    design: ["设计；规划", "design and use it 表示设计并使用它。"],
    different: ["不同的", "different views / different groups / different needs 都高频。"],
    difficulty: ["困难", "in the middle of difficulty lies opportunity 是经典表达。"],
    directly: ["直接地", "link directly with... 表示直接连接到某事。"],
    economic: ["经济的", "economic growth / economic pressure 都常见。"],
    easier: ["更容易的", "make it easier to... 是写作和口语常用结构。"],
    everyday: ["日常的", "everyday experience / everyday life 都很自然。"],
    examine: ["审视；检查", "examine a problem / examine evidence 都可用。"],
    examined: ["被审视的", "unexamined life 指未经审视的人生。"],
    exchange: ["交流；交换", "cultural exchange / information exchange 都常用。"],
    expand: ["扩大；扩展", "expand access / expand choices 都是好搭配。"],
    expectation: ["期待；期望", "social expectation / unrealistic expectation 都常见。"],
    expectations: ["期待；期望", "复数形式，常用于工作、家庭和教育压力。"],
    experience: ["经验；体验", "direct experience / work experience 都高频。"],
    experiences: ["经验；体验", "复数形式，常用于社会和教育话题。"],
    failure: ["失败", "possible failure、market failure 都常见。"],
    faster: ["更快的", "merely faster ones 表示仅仅更快的选择。"],
    force: ["力量；迫使", "a force that improves life 指改善生活的力量。"],
    general: ["一般的；普遍的", "general public / general trend 都常见。"],
    guided: ["被引导的", "guided by clear aims 表示由清晰目标引导。"],
    handle: ["处理；应对", "handle complex tasks 表示处理复杂任务。"],
    handling: ["处理；应对", "handling complex tasks 是 AI/工作话题常见表达。"],
    helps: ["帮助", "helps people make choices 是基础但高频结构。"],
    ignored: ["被忽视的", "trade-offs being ignored 表示被忽视的取舍。"],
    improve: ["改善；提高", "improve daily life / improve productivity 都高频。"],
    improvement: ["改善；提高", "meaningful improvement 指实质性改善。"],
    improves: ["改善；提高", "第三人称形式，常用于 technology improves...。"],
    increasingly: ["越来越多地", "which increasingly shapes... 是雅思写作高频副词。"],
    information: ["信息", "information access、reliable information 都高频。"],
    introduce: ["引入；介绍", "introduce a policy / technology 都常用。"],
    introduced: ["被引入的", "is introduced without clear rules 是好句型。"],
    issue: ["问题；议题", "social issue / policy issue / ethical issue 都常用。"],
    issues: ["问题；议题", "复数形式，常用于复杂社会话题。"],
    itself: ["它本身；自身", "the existence of... itself 是强调句常见结构。"],
    knowledge: ["知识", "specialised knowledge / practical knowledge 都高频。"],
    lack: ["缺乏", "lack of transparency / lack of funding 都常见。"],
    larger: ["更大的", "a larger room for evidence 是抽象表达。"],
    limit: ["限制；边界", "ethical limit / legal limit 都常见。"],
    limits: ["限制；边界", "复数形式，clear aims and ethical limits 是好搭配。"],
    local: ["本地的；地方的", "local residents / local authorities / local economy 都高频。"],
    long: ["长期的；长的", "long commutes / long-term value 都常见。"],
    manage: ["管理；处理", "manage resources / manage pressure 都高频。"],
    manager: ["管理者", "workplace、business、leadership 话题常见。"],
    managers: ["管理者", "复数形式，常作为企业和团队场景人物。"],
    matter: ["重要；事情", "what actually matters 表示真正重要的事。"],
    matters: ["重要；事情", "not every decision improves when... what matters... 都常见。"],
    measure: ["衡量；措施", "measure success / policy measure 都常见。"],
    measures: ["衡量；措施", "复数形式，preventive measures 指预防措施。"],
    narrow: ["狭窄的；变窄", "narrow definition / narrow human choice 都可用。"],
    narrowing: ["压缩；变窄", "without narrowing human choice 是高分表达。"],
    necessary: ["必要的", "before punishment becomes necessary 表示在惩罚变得必要前。"],
    obvious: ["明显的", "become obvious 表示变得明显。"],
    offer: ["提供", "offer people more choice 表示给人们更多选择。"],
    ordinary: ["普通的；平常的", "ordinary users / ordinary moments 都高频。"],
    overall: ["整体的；总体上", "overall impact / overall performance 都常用。"],
    patient: ["耐心的；患者", "作形容词或名词，医疗和个人品质话题都可用。"],
    patients: ["患者", "医疗健康话题高频。"],
    possible: ["可能的；可行的", "possible failure / better choices are still possible 都常见。"],
    pressure: ["压力", "exam pressure、social pressure、budget pressure 都高频。"],
    progress: ["进步；进展", "source of progress / slow progress 都常见。"],
    provided: ["倘若；前提是", "provided that... 是条件连接词，比 if 更正式。"],
    reach: ["到达；触达", "reach customers / reach information 都可用。"],
    real: ["真实的；真正的", "real value / real schedules / real mistakes 都常见。"],
    reality: ["现实", "reality is patient with our opinions 是好句。"],
    reduce: ["减少；降低", "reduce costs / reduce pollution / reduce pressure 都高频。"],
    reducing: ["减少；降低", "动名词形式，常用于政策目标。"],
    related: ["相关的", "related to privacy / related to debt 都常用。"],
    remains: ["仍然是；保持", "while remaining fragile 表示同时仍然脆弱。"],
    replace: ["替代；取代", "replace human judgment / replace envy 都可用。"],
    requires: ["需要；要求", "meaningful improvement requires... 是写作常用结构。"],
    resident: ["居民", "city resident / local resident 都常用。"],
    residents: ["居民", "复数形式，城市和社区话题高频。"],
    result: ["结果", "result of... / as a result 都高频。"],
    reveal: ["揭示；显示", "reveal hidden costs / reveal inequality 都可用。"],
    reveals: ["揭示；显示", "第三人称形式，常用于 it reveals...。"],
    rule: ["规则", "clear rule / rule of law 都常见。"],
    rules: ["规则", "复数形式，clear rules 是高频搭配。"],
    service: ["服务", "public service / digital service / customer service 都高频。"],
    services: ["服务", "复数形式，公共服务和商业服务都常用。"],
    shape: ["形状；塑造", "shape decisions / change the shape of... 都可用。"],
    shapes: ["塑造；影响", "technology shapes decisions 是好表达。"],
    simple: ["简单的", "a simple solution 常用于批判过度简化。"],
    simply: ["仅仅；简单地", "does not simply avoid difficulty 表示不只是回避困难。"],
    solve: ["解决", "solve visible problems 是常见表达。"],
    source: ["来源", "source of progress / source of pressure 都常见。"],
    space: ["空间；余地", "public space / room for evidence / thinking space 都可用。"],
    support: ["支持", "mental health support、public support、practical support 都高频。"],
    task: ["任务", "complex task、routine task、workplace task 都常见。"],
    tasks: ["任务", "复数形式，工作、学习、AI 话题高频。"],
    thine: ["你的", "古英语/文学用法，相当于 your，常见于 Shakespeare 句子。"],
    "trade-offs": ["取舍；权衡", "雅思写作高频词，表示选择一个方案时必须放弃的东西。"],
    trust: ["信任", "public trust、social trust、consumer trust 都高频。"],
    true: ["真实的；忠诚的", "be true to oneself 表示忠于自己。"],
    understand: ["理解", "understand risks / understand where they come from 都常用。"],
    useful: ["有用的；实用的", "useful action / useful tool 都常见。"],
    users: ["用户", "ordinary users、internet users、platform users 都高频。"],
    whether: ["是否；无论", "depends on whether... 是写作高频结构。"],
    while: ["虽然；然而；当……时", "while 可表示让步、对比或时间。"],
    wisely: ["明智地", "adopt something wisely 表示明智采用某事物。"],
    without: ["没有；在缺乏……的情况下", "without clear rules 是条件表达。"],
  });

  const sentenceWordPhonetics = {
    absence: "ˈæbsəns",
    abstract: "ˈæbstrækt",
    ...
    institutional: "ˌɪnstɪˈtuːʃənl",
    integration: "ˌɪntɪˈɡreɪʃn",
    intellectual: "ˌɪntəˈlektʃuəl",
    interdisciplinary: "ˌɪntərˈdɪsəpləneri",
  ...
  Object.assign(sentenceWordNotes, {
    above: ["在……之上；最重要的是", "This above all 表示最重要的是，经典文学表达。"],
    ahead: ["向前；领先", "get ahead 表示取得进展或领先。"],
    almost: ["几乎；差不多", "almost any how 表示几乎任何方式或困难。"],
    ancient: ["古代的", "ancient maxim 表示古老格言。"],
    adventure: ["冒险；经历", "Adventure is worthwhile 是经典短句，可用于成长和探索话题。"],
    aristotle: ["亚里士多德", "古希腊哲学家，经典名言常见作者。"],
    bear: ["承受；忍受", "can bear almost any how 表示能承受几乎任何困难。"],
    beauty: ["美；美感", "everything has beauty 可用于审美、观察和生活话题。"],
    begins: ["开始；起源于", "peace begins with... / learning begins when... 都常见。"],
    books: ["书籍", "reading、education、knowledge 话题基础词。"],
    brevity: ["简洁；简明", "Brevity is the soul of wit 是经典表达，强调表达要简洁有力。"],
    busy: ["忙碌的", "busy life 可用于工作压力和生活质量话题。"],
    carpe: ["把握；采摘", "Carpe diem 是拉丁短语，意思是把握今天。"],
    cast: ["掷出；投下；演员阵容", "The die is cast 表示事情已经决定、无法回头。"],
    cease: ["停止；终止", "cease to exist 表示停止存在。"],
    complicated: ["复杂的", "make life complicated 表示把生活变复杂。"],
    confucius: ["孔子", "中国思想家，经典名言作者。"],
    counselor: ["顾问；劝告者", "time is the wisest counselor 表示时间是最好的顾问。"],
    define: ["定义；界定", "define the future / define a concept 都可用。"],
    diem: ["日子；今天", "Carpe diem 中 diem 指 day，把握今天。"],
    die: ["骰子；死亡", "The die is cast 中 die 指骰子。"],
    drop: ["一滴；下降", "a drop vs an ocean 是表达已知和未知差距的比喻。"],
    edison: ["爱迪生", "Thomas Edison，常见于努力、失败和创新名言。"],
    einstein: ["爱因斯坦", "Albert Einstein，科学和创造力话题常见作者。"],
    eliot: ["乔治·艾略特", "George Eliot，英国作家，成长类名言常见作者。"],
    exaggerated: ["夸大的；被夸张的", "greatly exaggerated 表示被严重夸大。"],
    existed: ["存在过", "has ever existed 是现在完成时表达。"],
    exhausts: ["耗尽；使疲惫", "learning never exhausts the mind 表示学习不会耗尽心智。"],
    failed: ["失败了", "I have not failed 是经典复盘式表达。"],
    facts: ["事实", "facts do not cease to exist 是现实和证据话题好句。"],
    favor: ["偏爱；支持", "fortune favors the bold 表示命运偏爱勇敢者。"],
    favors: ["偏爱；支持", "第三人称形式，常见于经典句 Fortune favors the bold。"],
    fortune: ["命运；财富；运气", "fortune favors the bold 是经典勇气表达。"],
    gandhi: ["甘地", "Mahatma Gandhi，行动和价值观名言常见作者。"],
    genius: ["天才；天赋", "genius is... inspiration and perspiration 是经典努力表达。"],
    giant: ["巨人；伟大人物", "stand on the shoulders of giants 表示站在前人基础上。"],
    giants: ["巨人；伟大人物", "复数形式，常用于知识传承的比喻。"],
    hungry: ["饥饿的；渴望的", "Stay hungry 表示保持渴望和进取心。"],
    ignored: ["被忽视的", "facts are ignored 表示事实被忽视。"],
    imagination: ["想象力", "imagination is more important than knowledge 是创造力话题金句。"],
    insist: ["坚持；执意", "insist on doing 表示坚持做某事。"],
    inspiration: ["灵感；鼓舞", "inspiration and perspiration 是努力与天赋话题常见对比。"],
    journey: ["旅程；过程", "journey of a thousand miles 可用于长期目标。"],
    kindness: ["善意；仁慈", "no act of kindness is ever wasted 是关系和社会话题好句。"],
    laozi: ["老子", "中国思想家，经典格言作者。"],
    lies: ["位于；存在于", "in the middle of difficulty lies opportunity 是倒装表达。"],
    madness: ["疯狂；狂热", "a touch of madness 表示一点疯狂或非凡特质。"],
    maxim: ["格言；准则", "ancient maxim 指古老格言。"],
    nietzsche: ["尼采", "Friedrich Nietzsche，哲学类名言常见作者。"],
    ocean: ["海洋", "what we don't know is an ocean 是知识边界的比喻。"],
    opportunity: ["机会", "in difficulty lies opportunity 是逆境话题高频表达。"],
    pericles: ["伯里克利", "古希腊政治家，时间和智慧名言常见作者。"],
    perspiration: ["汗水；努力", "ninety-nine percent perspiration 表示大量努力。"],
    perfect: ["完美的", "done is better than perfect 是行动力金句。"],
    questioning: ["提问；质疑", "not to stop questioning 表示不要停止追问。"],
    refuge: ["避难所；退路", "last refuge 表示最后的躲避处。"],
    reports: ["报道；报告", "the reports of my death... 是马克·吐温幽默名句。"],
    rise: ["上升；成长", "you do not rise by... 表示不是靠某种方式真正成长。"],
    room: ["房间；空间", "a room without books 是阅读价值的比喻。"],
    sandberg: ["桑德伯格", "Sheryl Sandberg，行动力名言常见作者。"],
    shakespeare: ["莎士比亚", "William Shakespeare，英文经典句和文学表达重要来源。"],
    silence: ["沉默；安静", "the rest is silence / silence is strength 都是经典表达。"],
    socrates: ["苏格拉底", "古希腊哲学家，思考和自省类名言常见作者。"],
    sophistication: ["精致；高级；复杂性", "simplicity is the ultimate sophistication 是设计和表达金句。"],
    soul: ["灵魂；精神核心", "the soul of wit 表示机智的核心。"],
    step: ["一步；步骤", "one step / useful step 都可用于行动表达。"],
    shoulders: ["肩膀", "standing on the shoulders of giants 表示继承前人成果。"],
    thousand: ["一千；大量的", "a thousand miles 表示漫长旅程。"],
    truth: ["真相；真实", "tell the truth / face the truth 都高频。"],
    unexamined: ["未经审视的", "the unexamined life 指没有反思过的人生。"],
    unimaginative: ["缺乏想象力的", "the unimaginative 指缺乏想象力的人。"],
    virgil: ["维吉尔", "古罗马诗人，经典格言作者。"],
    wander: ["漫游；徘徊", "not all those who wander are lost 是探索类金句。"],
    wasted: ["被浪费的", "no act of kindness is ever wasted 表示善意不会白费。"],
    worthwhile: ["值得的", "worthwhile 表示值得投入时间或努力。"],
    wounds: ["伤口；创伤", "turn wounds into wisdom 表示把痛苦转化为智慧。"],
    yourself: ["你自己", "be yourself / promises to yourself 都是自我表达常见词。"],
  });

  Object.assign(sentenceWordPhonetics, {
    above: "əˈbʌv",
    ahead: "əˈhed",
    almost: "ˈɔːlmoʊst",
    ancient: "ˈeɪnʃənt",
    adventure: "ədˈventʃər",
    aristotle: "ˈærɪstɑːtl",
    bear: "ber",
    beauty: "ˈbjuːti",
    begins: "bɪˈɡɪnz",
    books: "bʊks",
    ...
    room: "ruːm",
    sandberg: "ˈsændbɜːrɡ",
    shakespeare: "ˈʃeɪkspɪr",
    silence: "ˈsaɪləns",
    socrates: "ˈsɑːkrətiːz",
  ...
  function normaliseWord(value) {
    ...
    if (sentenceWordNotes[lower]) return lower;
    if (irregular[lower]) return irregular[lower];
    if (lower.endsWith("ies") && sentenceWordNotes[`${lower.slice(0, -3)}y`]) return `${lower.slice(0, -3)}y`;
    if (lower.endsWith("es") && sentenceWordNotes[lower.slice(0, -2)]) return lower.slice(0, -2);
    if (lower.endsWith("s") && sentenceWordNotes[lower.slice(0, -1)]) return lower.slice(0, -1);
    return lower;
  }

  function renderAnnotatedSentence(sentence) {
    return String(sentence || "")
      .split(/([A-Za-z][A-Za-z'-]*)/g)
      .map((part) => {
        const key = normaliseWord(part);
        if (!sentenceWordNotes[key]) return esc(part);
        return `<button class="sentence-inline-word" type="button" data-sentence-word="${esc(key)}">${esc(part)}</button>`;
      })
      .join("");
  }

  function showSentenceWordInfo(key) {
    const info = sentenceWordNotes[key];
    if (!info) return;
    const phonetic = sentenceWordPhonetics[key] || "";
    let panel = document.querySelector(".sentence-word-popover");
    if (!panel) {
      panel = document.createElement("div");
      panel.className = "sentence-word-popover";
      document.body.appendChild(panel);
    }
    panel.innerHTML = `
      <div class="sentence-word-popover-head">
        <div>
          <strong>${esc(key)}</strong>
          ${phonetic ? `<em>/${esc(phonetic)}/</em>` : '<em>雅思高频 / 专业词汇</em>'}
        </div>
        <div class="sentence-word-popover-actions">
          <button type="button" data-speak-word="${esc(key)}">朗读</button>
          <button type="button" data-close-sentence-word>关闭</button>
        </div>
      </div>
      <p>${esc(info[0])}</p>
      <small>${esc(info[1])}</small>
    `;
    requestAnimationFrame(() => panel.classList.add("show"));
  }

  function hideSentenceWordInfo() {
    const panel = document.querySelector(".sentence-word-popover");
  ...
  function bindEvents() {
    ...
    els.card.addEventListener("click", (event) => {
      const item = activeSentence();
      const wordButton = event.target.closest("[data-sentence-word]");
      if (wordButton) {
        showSentenceWordInfo(wordButton.dataset.sentenceWord);
        return;
      }
    ...
    document.addEventListener("click", (event) => {
      const wordSpeak = event.target.closest("[data-speak-word]");
      if (wordSpeak) {
        speak(wordSpeak.dataset.speakWord, wordSpeak);
        return;
      }
      if (event.target.closest("[data-close-sentence-word]")) {
        hideSentenceWordInfo();
        return;
      }
      if (!event.target.closest(".sentence-word-popover") && !event.target.closest("[data-sentence-word]")) hideSentenceWordInfo();
    });
  }
