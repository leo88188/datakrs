...
- Latest deployed commit: `094e0f2` Make sentence vocabulary highlights visible.
...
- Classic sentences module: defaults to IELTS complex-sentence training, with 2,006 sentence cards total, 1,008 IELTS complex-sentence cards across 84 topics and 998 quote/golden-expression cards, grammar-pattern filters, topic filters, simple grammar-combination notes, search, random card, browser speech synthesis, clickable IELTS/professional vocabulary IPA phonetics, Chinese meanings and Chinese usage notes, local favorites and read progress.
